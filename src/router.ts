...
export default new Router({
  ...
  routes: [
    ...
    },
    {
      ...
      redirect: '/log/index',
      name: 'Log',
      meta: { title: '登陆日志', icon: 'form', category: 'home' },
      children: [{
        path: 'index',
        name: 'Log',
    ...
    },
    {
      ...
      name: 'Example',
      meta: { title: 'Example', icon: 'example' , category: 'home'  },
      children: [
        {
          path: 'table',
          name: 'Table',
        ...
        },
        {
          path: 'complextable',
          name: 'ComplexTable',
          component: () => import(/* webpackChunkName: "tree" */ '@/views/table/complexTable.vue'),
          meta: { title: 'complexTable', icon: 'test' },
        },
      ],
    },
    {
      ...
      children: [
        ...
        },
        {
          path: 'complextable',
          name: 'ComplexTable',
          component: () => import(/* webpackChunkName: "tree" */ '@/views/robot/complexTable.vue'),
